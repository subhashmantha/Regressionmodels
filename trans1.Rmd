...
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
The comparison shows a very small p-value of 1.2742 ?? 10-8, which allows us to reject the Null Hypothesis that the simple model may explain the MPG variable better, and thus opt for the multivariable model.
...
First of all the R-squared is 0.849, indicating that a great part of the variance is explained by this model. According to the model, weight and number of cylinders have a negative effect on mileage. Specifically,
